    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-12">
                <h1 class="section-block__title top-zero "><i class="icon-elect"></i>Избранные объекты</h1>
                ...
                <h2 class="section-block__title"><i class="icon-elect-2"></i>Избранные тренеры</h2>
                <ul class="favorite-list">
                    <li class="goods">
                        <div class="goods-photo">
                            <img src="img/jpeg_files/club-4.jpg" alt="club-1">
                        </div>
                        <div class="goods-prop">
                            <h4 class="goods-prop__title">Сеть фитнес-клубов Gold Fitness</h4>
                            <div class="goods-prop__partitions">
