                ...
                <div class="object-top goods block-with-border">
                    ...
                    <div class="object-top__slider">
                        <ul class="object-img-slider object-img-gallery">
                            <li class="object-img-slider__item" data-thumb="img/jpeg_files/trainer-1-1.jpg"
                                data-src="img/jpeg_files/trainer-1-1.jpg">
                                <img src="img/jpeg_files/trainer-1-1.jpg" alt="club">
                            </li>
                            <li class="object-img-slider__item" data-thumb="img/jpeg_files/trainer-1-1.jpg"
                                data-src="img/jpeg_files/trainer-1-1.jpg">
                                <img src="img/jpeg_files/trainer-1-1.jpg" alt="club">
                ...
                <div class="object-bottom">
                    <div id="responsive-tab" class="object-tabs">
                        <ul>
                            ...
                            <li class="object-tabs__title"><a href="#tab-4">Результаты</a></li>
                            <li class="object-tabs__title"><a href="#tab-5">Акции</a></li>
                        </ul>

                        <div id="tab-1">
                            <div class="object-tabs__content">
                                <p class="text-medium">В фитнес-клубе «Fitness Life» располагающийся в районе метро
                                    «Бабушкинская», могут
                                ...
                                <p class="text-medium">
                                    ...
                                    работоспособность, выравниваете мышечный дисбаланс и укрепляете весь мышечный
                                    каркас. 
                                </p>

                                <p class="text-medium">
                                    В центре «Архитектура красоты XXI век» вы достигаете желаемых целей, получая
                                    удовольствие!
                                </p>
                                            ...
                                            <div class="reviews-item__head clearfix">
                                                ...
                                                <div class="reviews-rating pull-right">
                                                    ...
                                                    <div class="rateit" data-rateit-resetable="false"
                                                         data-rateit-value="3.5" data-rateit-mode="font"></div>
                                                    <span class="rateit-value-now">4.5</span>
                                                </div>
                                            </div>
                                            <div class="reviews-item__body">
                                                <div class="reviews-content">
                                                    <p> Замечательный, уютный и действительно огромный фитнес-клуб
                                                        Sportown с хорошей базой.
                                                        Персонал компетентный, задорный и приятный в общении так что
                                                        ходить сюда одно удовольствие.
                                                    </p>

                                                    <p>
                                                        Людей не много (хотя возможно я просто не попадал в часы пик)
                                                        особо хотел отметить
                                                        прекрасный бассейн с хлоркой не перебарщивают вода комфортной
                                                        температуры и чистая.
                                                        После занятий можно расслабится, сделав массаж в общем я доволен
                                                        что не ошибся с
                                                        выбором.
                                                    </p>
                                                </div>
                                ...
                                <div class="reviews-add-form">
                                    ...
                                    <form action="#">
                                        <div class="row">
                                            <div class="col-sm-6 col-xs-12">
                                                <fieldset class="input-md-margin pseudo-placeholder">
                                                    <input type="text" id="user-name-1"
                                                           class="input-round-border input-md">
                                                    <label for="user-name-1">Ваше имя <span>*</span></label>
                                                </fieldset>
                                            </div>
                                            <div class="col-sm-6 col-xs-12">
                                                <fieldset class="input-md-margin pseudo-placeholder">
                                                    <input type="text" id="user-email-1"
                                                           class="input-round-border input-md">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <textarea class="border-input textarea-height col-xs-12"
                                        ...
                                        <div class="object-top__controls clearfix">
                                            ...
                                            <div class="goods-prop__right-block">
                                                <button type="submit" class="btn btn-medium btn-yellow-gradient">
                                                    Оставить отзыв
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <div id="tab-4">
                            <div class="object-tabs__content">
                                <h4 class="object-tabs__content--title goods-prop__title bold-text">Результаты
                                    учеников</h4></div>
                            <ul class="athlete-result-list clearfix">
                                <li class="athlete-result-list__item clearfix">
                                    <div class="athlete-result-photos">
                                        <div class="athlete-result-photos__before">
                                            <img src="img/jpeg_files/before-1.jpg" alt="before">
                                        </div>
                                        <div class="athlete-result-photos__after">
                                            <img src="img/jpeg_files/after-1.jpg" alt="after">
                                        </div>
                                    </div>
                                    <div class="athlete-result-content">
                                        <h4 class="athlete-result-content__title goods-prop__title">
                                            <i class="icon-kg"></i>
                                            <a href="#">Марина, 19 лет</a>
                                        </h4>

                                        <p>На самом деле главное - захотеть похудеть! Не просто быть недовольной своим
                                            весом и злиться на себя за толстоту, а вот конкретно захотеть похудеть. </p>

                                        <p>Тогда любая диета поможет - просто посмотрите, что вам лично больше подходит
                                            по пищевым привычкам. Удачи! Все получится)</p>
                                    </div>
                                </li>
                                <li class="athlete-result-list__item clearfix">
                                    <div class="athlete-result-photos">
                                        <div class="athlete-result-photos__before">
                                            <img src="img/jpeg_files/before-2.jpg" alt="before">
                                        </div>
                                        <div class="athlete-result-photos__after">
                                            <img src="img/jpeg_files/after-2.jpg" alt="after">
                                        </div>
                                    </div>
                                    <div class="athlete-result-content">
                                        <h4 class="athlete-result-content__title goods-prop__title">
                                            <i class="icon-kg"></i>
                                            <a href="#">Богдан, 32 года</a>
                                        </h4>

                                        <p>Фотографии мои просто приложение к рассказу. Спешу отметить, это не фото до и
                                            после похудения! </p>

                                        <p>Это просто мои фото! (На второй фотографии я через 2,5 года после начала
                                            похудения. Очень старалась сильно не поправляться) А лишний вес у меня был
                                            всегда.</p>
                                    </div>
                                </li>
                                <li class="athlete-result-list__item clearfix">
                                    <div class="athlete-result-photos">
                                        <div class="athlete-result-photos__before">
                                            <img src="img/jpeg_files/before-3.jpg" alt="before">
                                        </div>
                                        <div class="athlete-result-photos__after">
                                            <img src="img/jpeg_files/after-3.jpg" alt="after">
                                        </div>
                                    </div>
                                    <div class="athlete-result-content">
                                        <h4 class="athlete-result-content__title goods-prop__title">
                                            <i class="icon-kg"></i>
                                            <a href="#">Алеся, 25 лет</a>
                                        </h4>

                                        <p>Я тоже решила, наконец-то ;) прохладное лето как то и желание отбивало
                                            подкорректировать фигуру. Но уже должно быть тепло и я решила основательно,
                                            точнее комплексно взяться за себя. </p>

                                        <p>Спорт, правильное питание, ещё хочу подключить что-то из салонных процедур,
                                            пройти полный курс массажа, может какие-то аппаратные штучки.</p>
                                    </div>
                                </li>
                            </ul>
                            <div class="text-center">
                                <a href="#" class="link-button">Загрузить еще</a>
                            </div>
                        </div>
                        <div id="tab-5">
                            <div class="object-tabs__content">
                                <h4 class="object-tabs__content--title goods-prop__title bold-text">Акции спортивного
                                    клуба Fitness Life</h4>
                                <ul class="action-list clearfix">
                                    <li class="goods">
                                        ...
                                        <div class="goods-prop">
                                            <h4 class="goods-prop__title bold-text"><a href="#">Акция на месячные
                                                    абонементы VeGym</a></h4>
                                            <hr>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <div class="goods-prop__right-block">
                                                    ...
                                                    <div class="goods-prop__more">
                                                        <a href="#" class="btn btn-medium btn-yellow-gradient">Купить
                                                            пакет</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li class="goods">
                                        ...
                                        <div class="goods-prop">
                                            <h4 class="goods-prop__title bold-text"><a href="#">Безлимитный массаж в
                                                    Зебра</a></h4>
                                            <hr>
                                    ...
                                    <li class="goods">
                                        ...
                                        <div class="goods-prop">
                                            <h4 class="goods-prop__title bold-text"><a href="#">Бесплатный вход на 1
                                                    день в X-Fit</a></h4>
                                            <hr>
